...
const T = {
  ...
  es: {
    ...
    about: {
      ...
      p5: "Para nosotros, los deportistas de élite son el imán, la fuente de energía. Todo lo demás —marcas, emprendedores, patrocinadores, hospitality, membresía y las distintas oportunidades— es consecuencia del círculo que se forma a su alrededor.",
