...
const T = {
  ...
  es: {
    ...
    about: {
      ...
      p1: "No solo por sus logros deportivos, sino por lo que representan: disciplina, carácter, respeto, historia y legado.",
      p2: "Ese círculo ya existe. Pero muchas veces aparece de forma aislada, sin identidad clara, sin continuidad y sin una lógica que lo sostenga en el tiempo.",
      p3: "Vesper busca ordenar ese mundo con sentido.",
      ...
      p4: "Queremos construir una plataforma privada alrededor del deporte de élite, donde los atletas tengan un lugar real: un espacio cuidado, con pertenencia, criterio y contexto, que puedan compartir con su propia red y con pares de distintas disciplinas.",
      p5: "Para Vesper, los atletas de élite son el imán.\nTodo lo demás —marcas, emprendedores, patrocinadores, hospitalidad, membresía y oportunidades— nace como consecuencia del círculo que se forma alrededor de ellos.",
      visionLabel: "",
      vp1: "Vesper está diseñado para crecer en diferentes disciplinas y momentos deportivos alrededor del mundo, respetando siempre los códigos, la cultura y la identidad de cada deporte.",
      vp2: "No buscamos celebridades.\nBuscamos personas con historia, carácter, legitimidad y criterio.",
      vBullets: [],
      vp3: "Queremos trascender lo conocido. Vesper está convencido de que los atletas de élite poseen ese poder, porque ya lo han demostrado. Si esa energía se canaliza en una misma dirección, pueden construirse cosas que hoy todavía parecen inimaginables.",
      vp4: "La membresía es únicamente por invitación.",
    ...
    members: {
      eyebrow: "Miembros", loginTitle: "Acceso para miembros.", loginDesc: "Ingresá con tus credenciales aprobadas de Vesper.",
      emailLabel: "Email", pwInputLabel: "Contraseña", continueBtn: "Continuar",
      createTitle: "Creá tu contraseña.",
      ...
      wrongPwMsg: "Contraseña incorrecta. Intentá de nuevo.",
    },
    application: {
      ...
      {eventOpen && (
        <div style={{ position: "fixed", inset: 0, zIndex: 100, background: "#06080F", overflowY: "auto", animation: "vFadeIn .5s both" }}>
          ...
          <div style={{ position: "relative", minHeight: isMobile ? "52vh" : "62vh", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "clamp(80px,12vh,140px) clamp(28px,6vw,80px) clamp(60px,8vh,100px)", overflow: "hidden" }}>
            <div style={{ position: "absolute", inset: 0, backgroundImage: "url('/assets/ramses-puerta-de-alcala.jpg')", backgroundSize: "cover", backgroundPosition: "center center", zIndex: 0 }} />
